...
def main():
    ...
    source_directory = '../data/testAdata/Test_A set/png'
    padded_directory = '../data/testAdata/padding'
    resized_directory = '../data/testAdata/resized'
...
# %%
make_gray('../data/testAdata/resized','../data/testAdata/gray/img')



# %%
make_test_caption('../data/testAdata/gray/img','../data/testAdata/gray')
